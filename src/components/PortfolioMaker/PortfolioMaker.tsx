      ...
      <div>
        <Accordion defaultExpanded >
          <AccordionSummary
            ...
            sx={{
              height: "40px",
              backgroundColor: "#8fb8ea"
            }}
          >
            <Typography >
              <span className='acc-header'><img className='header-logo' src={personalDetailsLogo}></img>&nbsp;Personal Details</span>
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
        ...
        <Accordion>
          ...
          >
            <Typography>Professional BackGround</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
        ...
        <Accordion>
          ...
          >
            <Typography className='acc-header'>
              <span className='acc-header'><img className='header-logo' src={personalDetailsLogo}></img>&nbsp;Project Work</span>
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
        ...
        <Accordion>
          ...
          >
            <Typography className='acc-header'>
              <span className='acc-header'><img className='header-logo' src={personalDetailsLogo}></img>&nbsp;Contact Details</span>
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
